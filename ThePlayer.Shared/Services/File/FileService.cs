...
{
    //TODO: what to replace [ServiceBehvior] from .NET 4.8 with in .NET 5?
    //TODO: how to reomove teh Prism.Ioc.IContainerProvider usage
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        private async void AddFilesTimerElapsedHandler(Object sender, ElapsedEventArgs e)
        {
            ...
            if (EnvironmentUtils.IsSingleInstance(ProductInformation.ApplicationName))
            {
                ...
                // TODO: how to replacye System.Windows.Applicaiton here
