...
using ThePlayer.Shared.Services.Cache;
using ThePlayer.Shared.Services.Indexing;
using System;
...
// TODO: need to update System.Runtime.Caching to .NET 5
...
namespace ThePlayer.Shared.Services.MetaDataService
{
    public class MetadataService : IMetadataService
    {
        ...
        // TODO: need to update System.Runtime.Caching.ObjectCach to .NET 5
        ...
        private byte[] GetAlbumArtwork(string filename, int size)
        {
            ...
            if (albumArtwork != null)
            {
                ...
                {
                    // TODO: need to fix the Image2ByteArray to work in .NET 5
            ...
            if (System.IO.File.Exists(filename))
            {
                await Task.Run(() =>
                {
                    lock (artworkCacheLock)
                    {
                        ...
                        // TODO: need to update System.Runtime.Caching.ObjectCache to .NET 5
                        ...
                        if (artwork == null)
                        {
                            ...
                            if (artwork != null)
                            {
                                ...
                                // TODO: need to update System.Runtime.Caching.CacheItemPolicy to .NET 5
